...
class SMS:
    ...
    def send(self, recipients_message, message_recipients, sender=None):
        ...
        try:
            ...
            response = self.sms.send(message, recipients, sender) #FIXME: Type checker warning: Cannot access member "send" for type "None" \n Member "send" is unknown
            print(response)
...
# if __name__ == "main": # fmt: skip
    # sms = SMS() # fmt: skip
    # sms.send("Hello, this is a test message", ["+254712345678"]) # fmt: skip
